...
export const metadata: Metadata = {
  title: "About",
  description:
    "OMU Innovation Frontier (OIF) について。大阪公立大学のAI・テクノロジー好きが集まる学生コミュニティです。",
  alternates: {
...
const beliefs = [
  {
    number: "01",
    title: "深く考える",
    body: "論文を読み、数式と向き合い、本質を掴む。AI理論・LLMの仕組みを表面だけでなく、根拠から理解することを大切にしている。",
  },
  {
    number: "02",
    title: "とにかく作ってみる",
    body: "KaggleへのチャレンジやAIモデルの実装、アプリ開発も。試行錯誤しながらコードを書いていくうちに、理解が深まっていく。",
  },
  {
    number: "03",
    title: "外の世界に出てみる",
    body: "大学発ベンチャーでインターンをしているメンバーもいる。学校の外で経験を積むことを、自然な選択肢として持っていたい。",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-black/80 font-medium">
              大阪公立大学発ベンチャーのAffectify・Mi&Tでインターンとして実務経験を積んでいるメンバーが在籍しています。勉強会に参加するだけでなく、実際の現場に出ていくことも自然にできる環境です。
            </p>
          </div>
        </div>
      </section>
