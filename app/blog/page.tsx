    ...
    <div className="on-dark bg-night text-white -mt-14 md:-mt-16 pt-14 md:pt-16 min-h-screen">
      ...
      <section className="bg-night">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 section-y">
          {posts.length === 0 ? (
            <p className="font-mono text-sm text-white/60">// no posts yet</p>
          ) : (
              ...
              {posts.map((post) => (
                ...
                >
                  <div className="grid md:grid-cols-[180px_1fr] gap-4 md:gap-10">
                    <div className="font-mono text-xs tracking-widest text-white/60 pt-1">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 font-mono text-[11px] tracking-widest text-white/60">
                        {post.tags.map((t) => (
