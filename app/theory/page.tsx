    ...
    <div className="on-dark bg-night text-white -mt-14 md:-mt-16 pt-14 md:pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20 w-full">
          <div className="grid lg:grid-cols-12 gap-12 xl:gap-16 items-center">
            <div className="lg:col-span-6 animate-fade-up">
              ...
              <Link
                href="/join/"
                className="inline-flex items-center gap-2 bg-theory text-white px-8 py-4 text-sm font-bold tracking-widest uppercase border border-theory hover:bg-theory-bright hover:text-night hover:border-theory-bright transition-colors duration-200 shadow-[0_0_50px_-12px_rgba(192,39,28,0.8)]"
              >
                深く知る側になる
            ...
            <div className="lg:col-span-6 animate-fade-up [animation-delay:140ms]">
              <div className="border border-white/12 bg-night-2/80 backdrop-blur-sm shadow-card p-8 md:p-10 font-mono">
                ...
                <div className="mt-8 pt-6 border-t border-white/10 text-sm text-white/55">
      ...
      <section className="border-t border-white/10 bg-night">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 section-y-lg">
          ...
          <Reveal delay={100}>
            <div className="h-1 w-full bg-gradient-to-r from-white/10 via-white/30 to-theory-bright mb-10" />
      ...
      <section className="border-t border-white/10 bg-night-2">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 section-y-lg">
          <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-12 lg:gap-16">
            ...
            <Reveal delay={100} className="border border-white/10 bg-night font-mono text-sm">
              {reading.map((r, i) => (
                <div
                  key={r}
                  className="group flex items-baseline gap-4 px-5 py-4 border-b border-white/5 last:border-0 hover:bg-white/[0.03] transition-colors"
                >
                  <span className="text-theory-bright shrink-0">{`[${String(i + 1).padStart(2, "0")}]`}</span>
                  <span className="text-white/75 group-hover:text-white transition-colors">{r}</span>
                </div>
              ))}
            </Reveal>
          </div>
