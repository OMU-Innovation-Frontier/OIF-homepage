                ...
                <div className="footer-content">
                    ...
                    <div className="footer-links">
                        ...
                        <ul>
                            ...
                            <li><HashLink to="/#areas" scroll={scrollWithOffset}>Areas</HashLink></li>
                    ...
                    <div className="footer-contact">
                        ...
                        <div className="social-icons">
                            <a href="https://discord.gg/yxSrdGzsnd" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Discord">
